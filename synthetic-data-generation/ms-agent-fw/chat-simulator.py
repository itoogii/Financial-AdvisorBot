...
# Adapted from Agent-Framework github reposity. 
...
async def main() -> None:
    ...
    async with AzureCliCredential() as credential:
        ...
        expert = ChatAgent(
            name="FinanceExpert",
            instructions=(
                "You are an expert in Finance in a workgroup. "
                "Your job is to answer Finance related questions and refine your answer "
        ...
        verifier = ChatAgent(
            name="AnswerVerifier",
            instructions=(
                "You are a investment expert in a workgroup. "
